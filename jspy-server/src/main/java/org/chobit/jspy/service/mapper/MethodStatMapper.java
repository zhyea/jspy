...
public interface MethodStatMapper {
    ...
    @Insert({
            "<script>",
            "insert into method_stat(app_code, ip, method_id, std_dev, min, max, mean, percentile999, percentile98, percentile95, percentile90, percentile75, median, event_time)",
            "values",
